...
<article id="node-<?php print $node->nid; ?>" class="post grid <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <!-- Begin media blog -->
    <div class="media-blog">
      ...
      <div class="hover-overlay">
        <div class="inner">
          <a href="<?php print $node_url;?>">VIEW POST</a>
        </div>
      </div>
    </div> 
  <!-- End media blog -->
  ...
  <section class="post-content">
    ...
    <div class="meta">
      ...
      <span class="date"><?php print date('d F Y', $created);?> </span> | 
      <span class="comment-count"> 
      <i class="fa fa-comments"></i> <?php print $comment_count;?> comments
      </span>
    ...
    <a class="text-readmore" href="<?php print $node_url;?>">[Read more]</a>
