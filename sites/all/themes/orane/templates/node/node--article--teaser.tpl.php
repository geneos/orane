...
*/
?>
<article id="node-<?php print $node->nid; ?>" class="post teaser <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <section class="post-content">
    ...
    <div class="readmore">
      <a role="button" class="dexp-shortcodes-button btn btn-xs style02" href="<?php print $node_url;?>">Read more</a>
    </div>
  </section>
 </article> 